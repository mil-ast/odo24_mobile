...
import 'package:odo24_mobile/presentatin/car_screen/groups/dialogs/group_create/group_create_cubit.dart';
...
class GroupCreateWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocListener<GroupCreateCubit, AppState>(
        listener: (context, state) {
          if (state is AppStateSuccess<GroupModel>) {
